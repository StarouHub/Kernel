        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (empty($contenu)) {
                ...
                if (strpos($contenu, '#') !== false) {
                    $validationErrors[] = "Le caractère # n'est pas autorisé.";
                }
                
                // Vérifier la séquence **
                if (strpos($contenu, '**') !== false) {
                    $validationErrors[] = "La séquence ** n'est pas autorisée.";
                }
                
                // Vérifier le mot "fruit" (insensible à la casse)
                if (preg_match('/\bfruit\b/i', $contenu)) {
                    $validationErrors[] = "Le mot \"fruit\" n'est pas autorisé.";
                }
