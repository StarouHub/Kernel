...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nom) || empty($icon)) {
        ...
        $categorieController->updateCategorie($id, $nom, $icon, $description);
...
<head>
    ...
    <title>Modifier une Catégorie - Backoffice Kernel</title>
        ...
        <div class="row">
            ...
            <div class="main-content">
                <div class="page-header">
                    <h1><i class="bi bi-pencil text-primary"></i> Modifier une Catégorie</h1>
                    <p class="text-muted mb-0">Modifiez les informations de la catégorie</p>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="icon-preview" id="iconPreview">
                                        <i class="bi bi-<?php echo htmlspecialchars($categorie['icon']); ?>"></i>
                                    </div>
                                </div>
                            </div>
