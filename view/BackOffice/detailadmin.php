...
<head>
    ...
    <style>
        ...
        /* Validation rouge pour champs vides */
    ...
    <div class="main-content">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb bg-white p-3 rounded shadow-sm">
                <li class="breadcrumb-item"><a href="dashboard2.php"><i class="bi bi-house"></i> Dashboard</a></li>
        ...
        <div class="reclamation-header-card">
            <div class="row align-items-start">
                <div class="col-md-8">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h2 class="reclamation-title mb-0"><?= htmlspecialchars($reclamation['titre']) ?></h2>
                    ...
                    <div>
                        <h6 class="text-dark mb-2"><i class="bi bi-file-text"></i> Description :</h6>
                        <div class="description-box">
                            <p class="mb-0"><?= nl2br(htmlspecialchars($reclamation['description'])) ?></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="text-center py-5">
                        ...
                        <h5 class="mt-3">Aucune pièce jointe</h5>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('adminReplyForm').addEventListener('submit', function(e) {
                const messageField = document.getElementById('admin_message');
                const message = messageField.value.trim();
                if (!message) {
                    e.preventDefault();
                    messageField.classList.add('is-invalid');
                    showToast('Veuillez saisir un message avant d\'envoyer.', 'danger');
                    messageField.focus();
                    return false;
                } else {
            ...
            // Supprimer la validation rouge quand l'utilisateur tape
