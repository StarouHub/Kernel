        ...
        <div class="content-row">
            ...
            <div class="card">
                ...
                <div class="p-4">
                    ...
                    <a href="../FrontOffice/evenements-list.php" class="action-btn text-decoration-none">
                        <div class="action-icon" style="background: #f59e0b;">
                            <i class="bi bi-calendar-event"></i>
                        </div>
                        <div>
                            <div class="fw-bold">Événements (FrontOffice)</div>
                            <small class="text-muted">Voir les événements côté utilisateur</small>
                        </div>
                    </a>
