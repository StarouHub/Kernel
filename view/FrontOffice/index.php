...
<body>
    ...
    <div class="left-header">
        <?php if ($user['role'] === 'admin'): ?>
            <a href="../backoffice/admin.php" class="btn-user-action admin">
                <i class="bi bi-shield-lock"></i>
                <span>Administration</span>
            </a>
        <?php else: ?>
            <a href="profil-utilisateur.php" class="btn-user-action profile">
    ...
    <?php if ($isAdmin): ?>
        <a href="../BackOffice/admin.php" class="admin-fab" title="Panneau d'administration">
            <i class="bi bi-shield-lock"></i>
        </a>
    <?php endif; ?>
=======
