...
<body>
    <!-- Navigation -->
    <nav class="navbar navbar-kernel">
        <div class="container">
            <div class="d-flex align-items-center w-100">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h1 class="h4 mb-0 text-white fw-bold">Kernel Platform</h1>
                        <small class="text-white opacity-75">Interface Utilisateur</small>
                    </div>
                </div>
                ...
                <div class="ms-auto d-flex align-items-center">
                        ...
                        <div class="dropdown-menu dropdown-menu-end p-0" style="min-width: 300px;">
                            ...
                            <div class="p-3">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div>
                                        <small class="fw-bold">Réclamation #12 résolue</small>
                                        <br>
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div>
                                        <small class="fw-bold">Nouvelle réponse sur #8</small>
                                        <br>
                                        <small class="text-muted">Il y a 1 jour</small>
                                    </div>
                                </div>
                                <hr class="my-2">
                                <a href="#" class="small text-center d-block text-decoration-none">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-light d-flex align-items-center" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-md-inline"><?php echo htmlspecialchars($nom_utilisateur); ?></span>
                        </button>
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><h6 class="dropdown-header">Connecté en tant que <?php echo $role; ?></h6></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="mesreclamations.php"><i class="bi bi-list me-2"></i>Mes réclamations</a></li>
                            <li><a class="dropdown-item" href="nouvellereclamation.php"><i class="bi bi-plus-circle me-2"></i>Nouvelle réclamation</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="../../index.php"><i class="bi bi-house me-2"></i>Accueil</a></li>
    ...
    <div class="container py-4">
        ...
        <div class="welcome-section">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h2 class="fw-bold mb-2">Bonjour, <?php echo htmlspecialchars($nom_utilisateur); ?> !</h2>
                    <p class="mb-0">Bienvenue sur votre espace de gestion des réclamations.</p>
                </div>
                <div class="col-md-4 text-end">
                    <a href="nouvellereclamation.php" class="btn btn-light btn-lg">
