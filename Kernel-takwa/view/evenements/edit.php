...
<div class="page-header">
  <div class="container">
    <h1><i class="bi bi-pencil"></i> Modifier un événement</h1>
        ...
        <form id="eventForm" action="index.php?action=save" method="post" onsubmit="return validerEvenement();">
          ...
          <div class="row">
            <div class="mb-3 col-md-6">
              ...
              <select class="form-select" id="type" name="type">
                ...
                <option value="Workshop" <?php echo ($evenement['type'] ?? '') === 'Workshop' ? 'selected' : ''; ?>>Workshop</option>
                <option value="Hackathon" <?php echo ($evenement['type'] ?? '') === 'Hackathon' ? 'selected' : ''; ?>>Hackathon</option>
                <option value="Conférence" <?php echo ($evenement['type'] ?? '') === 'Conférence' ? 'selected' : ''; ?>>Conférence</option>
                <option value="Meetup" <?php echo ($evenement['type'] ?? '') === 'Meetup' ? 'selected' : ''; ?>>Meetup</option>
                <option value="Webinaire" <?php echo ($evenement['type'] ?? '') === 'Webinaire' ? 'selected' : ''; ?>>Webinaire</option>
              </select>
            ...
            <div class="mb-3 col-md-6">
              ...
              <input class="form-control" 
                     ...
                     value="<?php echo htmlspecialchars($dateFormatted); ?>">
          ...
          <div class="row">
            ...
            <div class="mb-3 col-md-6">
              ...
              <input class="form-control" 
                     ...
                     placeholder="Ex : 50"
                     value="<?php echo htmlspecialchars($evenement['capacite'] ?? ''); ?>">
          ...
          <div class="mb-3">
            ...
            <input class="form-control" 
                   ...
                   value="<?php echo htmlspecialchars($evenement['user_id'] ?? '1'); ?>">
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" 
                      ...
                      placeholder="Décrivez le contenu, les objectifs et le public cible de l'événement."><?php echo htmlspecialchars($evenement['description'] ?? ''); ?></textarea>
          ...
          <div class="d-flex flex-wrap gap-2 mt-4">
            <button type="submit" class="btn-primary-gradient">
              <i class="bi bi-save"></i> Mettre à jour l'événement
            </button>
...
<script>
  ...
  function validerEvenement() {
    ...
    if (!dateValue) {
      ...
      date.classList.add("field-invalid");
      if (errDate) {
        errDate.textContent = "Vous ne pouvez pas modifier un événement avec une date passée.";
        errDate.style.display = "block";
      }
    }
