                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="../../../kernel-takwa/index.php">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="../../../kernel-ali/view/FrontOffice/investissement.php">
                                    <i class="bi bi-graph-up-arrow"></i> investissement page
                                </a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href=../../../vv/public/index.php>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="../../..//kernel_cirine/indexx.php">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item" href="../../../Kernel/view/FrontOffice/profile.php">
                                    <i class="bi bi-person"></i> Mon profil
                                </a></li>
                                
                                <li><a class="dropdown-item" href="../../../Kernel/view/FrontOffice/logout.php">
