...
/*
    ...
    - $reponse est déjà chargé avant cette vue (id, contenu, sujet_id)
    - $error peut être défini par le contrôleur
*/
?>
...
<script>
document.getElementById('form-reponse-edit').addEventListener('submit', function(e) {
    ...
    if (hasStar || hasHash || hasFruit) {
        e.preventDefault();
        fieldError.textContent = "Vous ne pouvez pas publier de réponse contenant *, # ou fruit. Veuillez les supprimer.";
        textarea.focus();
    }
});
</script>
