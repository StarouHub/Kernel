...
// Services de mailing supprimés - remplacés par génération PDF
...
class ActualiteController
{
    ...
    public function addActualite(Actualite $actualite)
    {
        ...
        try {
            ...
            $actualiteId = $db->lastInsertId();
            
            // Log de création d'actualité (PDF disponible via generate-pdf-simple-fixed.php)
            error_log("Nouvelle actualité créée - ID: $actualiteId, Projet: " . $actualite->getProjetId());
            
            return [
                'success' => true,
                'actualite_id' => $actualiteId,
                'pdf_available' => true,
                'pdf_url' => 'generate-pdf-simple-fixed.php?id=' . $actualite->getProjetId()
            ];
        } catch (Exception $e) {
    ...
    public function updateActualite(Actualite $actualite, $id)
    {
        try {
            ...
            // Log de mise à jour d'actualité
            error_log("Actualité mise à jour - ID: $id, Projet: " . $actualite->getProjetId());
